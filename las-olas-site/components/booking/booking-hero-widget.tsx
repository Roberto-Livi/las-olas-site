...
function MobileWidget() {
  return (
    <div className="relative mx-auto w-full max-w-[21rem]">
      ...
      {/* BOOKING WIDGET REFINEMENT */}
      <div className="relative overflow-hidden rounded-[16px] border border-white/10 bg-white/10 shadow-[0_16px_44px_-32px_rgba(0,0,0,0.7)] ring-1 ring-white/10 backdrop-blur-2xl">
        ...
        <div className="relative grid grid-cols-3 divide-x divide-white/12 px-4 py-2 text-sm text-white/90">
        ...
        <div className="relative flex flex-col items-center justify-center gap-1.5 px-4 py-2.5">
          <Button className="h-10 w-full rounded-[12px] bg-teal-800/90 px-4 text-[12.5px] font-semibold text-white shadow-[0_14px_44px_-30px_rgba(0,0,0,0.9)] ring-1 ring-teal-100/55 hover:bg-teal-900">
            Check availability
          </Button>
          {/* UPDATED */}
          <p className="text-[10px] uppercase tracking-[0.14em] text-white/70">
            Best rate guaranteed · No Airbnb fees · Direct support
          </p>
        </div>
      </div>
    </div>
...
function DesktopWidget() {
  return (
    <div className="relative mx-auto w-full max-w-4xl">
      ...
      {/* BOOKING WIDGET REFINEMENT */}
      <div className="relative overflow-hidden rounded-[20px] border border-white/10 bg-white/12 shadow-[0_20px_76px_-52px_rgba(0,0,0,0.82)] ring-1 ring-white/10 backdrop-blur-2xl">
        ...
        <div className="relative flex items-center gap-4.5 px-5 py-3.5">
