...
function MobileWidget() {
  return (
    <div className="relative mx-auto w-full max-w-[20rem]">
      <div className="absolute inset-0 -z-10 translate-y-1 rounded-[18px] bg-gradient-to-r from-white/14 via-cyan-100/10 to-amber-100/10 blur-3xl opacity-70" />

      <div className="relative overflow-hidden rounded-[14px] border border-white/14 bg-white/10 shadow-[0_16px_44px_-32px_rgba(0,0,0,0.75)] ring-1 ring-white/14 backdrop-blur-2xl">
        ...
        <div className="relative grid grid-cols-3 divide-x divide-white/12 px-3 py-1.5 text-sm text-white/90">
        ...
        <div className="relative flex items-center justify-center px-3.5 py-2">
          <Button className="h-7.5 w-full rounded-[11px] bg-teal-800/90 px-3 text-[12px] font-semibold text-white shadow-[0_12px_40px_-32px_rgba(0,0,0,0.9)] ring-1 ring-teal-100/55 hover:bg-teal-900">
            Check availability
          </Button>
        </div>
      </div>
...
function DesktopWidget() {
  return (
    <div className="relative mx-auto w-full max-w-4xl">
      ...
      <div className="relative overflow-hidden rounded-[20px] border border-white/14 bg-white/12 shadow-[0_22px_80px_-52px_rgba(0,0,0,0.85)] ring-1 ring-white/14 backdrop-blur-2xl">
        ...
        <div className="relative flex items-center gap-4 px-6 py-3.5">
          ...
          <Button className="flex-none rounded-[14px] bg-teal-800/90 px-5 py-2 text-sm font-semibold text-white shadow-[0_18px_50px_-34px_rgba(0,0,0,0.85)] ring-1 ring-teal-100/55 hover:bg-teal-900">
            View availability
          </Button>
        </div>
      </div>
...
function Field({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex flex-1 items-center justify-between gap-2 rounded-[12px] bg-white/14 px-3 py-1.5 text-[13px] font-semibold ring-1 ring-white/20">
