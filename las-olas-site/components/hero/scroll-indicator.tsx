...
export function ScrollIndicator() {
  ...
  return (
    <div
      className={`pointer-events-none absolute left-1/2 bottom-2.5 sm:bottom-3.5 -translate-x-1/2 flex flex-col items-center gap-1 sm:gap-1.5 text-white drop-shadow-2xl z-40 transition-opacity duration-300 ${
